...
add_fileset_file vga.v VERILOG PATH vga2.v TOP_LEVEL_FILE
...
add_interface_port conduit_end coe_red export Output 8
add_interface_port conduit_end coe_green export Output 8
add_interface_port conduit_end coe_blue export Output 8
