...
set_module_property NAME zlave_template
set_module_property VERSION 1.0
set_module_property GROUP Jasper
set_module_property AUTHOR JCJB
set_module_property DISPLAY_NAME zlave_template
set_module_property TOP_LEVEL_HDL_FILE zlave_template.v
set_module_property TOP_LEVEL_HDL_MODULE zlave_template
...
# | files
# | 
add_file zlave_template.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
